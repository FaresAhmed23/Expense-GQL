...
const TransactionPage = () => {
	...
	return (
		<div className="max-w-4xl mx-auto flex flex-col items-center relative">
			<p className="md:text-4xl text-2xl lg:text-4xl font-bold text-center relative z-50 mb-4 mr-4 bg-gradient-to-r from-pink-600 via-indigo-400 to-pink-600 inline-block text-transparent bg-clip-text">
